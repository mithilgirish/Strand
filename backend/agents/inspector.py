    ...
    steps = [
        {
            "step_id": "IST-001",
            "seq": 1,
            "desc": "Verify physical clearance & foundation compliance",
            "criteria": "No cracks, standard seismic anchor bolts torque",
            "param": "bolting_compliance",
            "expected": "100%",
            "unit": "",
            "clause": "§5.2.1",
        },
        {
            "step_id": "IST-002",
            "seq": 2,
            "desc": "Fuel / fluid levels verification at 100% load"
            if is_gen
            else "Verify water circulation flow rates",
            "criteria": "Consumption within ±5% of design spec (260 L/h)"
            if is_gen
            else "Minimum 1200 gpm at full load",
            "param": "fuel_rate" if is_gen else "water_flow",
            "expected": 260 if is_gen else 1200,
            "unit": "L/h" if is_gen else "GPM",
            "clause": "§6.2.3" if is_gen else "§6.3.1",
        },
        {
            "step_id": "IST-003",
            "seq": 3,
            "desc": "Acoustic attenuation performance check",
            "criteria": "Noise levels below 85 dBA at 1 meter",
            "param": "acoustic_dba",
            "expected": 85,
            "unit": "dBA",
            "clause": "§8.4.1",
        },
        {
            "step_id": "IST-004",
            "seq": 4,
            "desc": "Structural vibrations monitoring",
            "criteria": "Velocity peak below 4.5 mm/s",
        ...
        },
        {
            "step_id": "IST-005",
            "seq": 5,
            "desc": "Thermal threshold performance under peak load",
            "criteria": "Continuous thermal clearance at 50°C ambient",
            "param": "thermal_max",
            "expected": 50,
            "unit": "°C",
            "clause": "§6.7.1",
        },
        {
            "step_id": "IST-006",
            "seq": 6,
            "desc": "Safety shut-off valve timing test",
            "criteria": "Closes fully in under 2.0 seconds",
            "param": "cutoff_time",
            "expected": 2.0,
            "unit": "s",
            "clause": "§7.1.3",
        },
        {
            "step_id": "IST-007",
            "seq": 7,
            "desc": "Earthing ground loop impedance",
            "criteria": "Resistance below 1.0 Ohm",
        ...
        },
        {
            "step_id": "IST-008",
            "seq": 8,
            "desc": "Control panel telemetry sync",
            "criteria": "Modbus registers reporting standard values",
            "param": "telemetry_sync",
            "expected": "Active",
            "unit": "",
            "clause": "§10.2.1",
        },
        {
            "step_id": "IST-009",
            "seq": 9,
            "desc": "Overcurrent relay trip test",
            "criteria": "Breaker trips at 120% rating in under 400ms",
            "param": "trip_time",
            "expected": 400,
            "unit": "ms",
            "clause": "§9.3.2",
        },
        {
            "step_id": "IST-010",
            "seq": 10,
            "desc": "Ventilation intake dampers operations",
            "criteria": "Dampers open fully in under 5.0 seconds",
            "param": "damper_time",
            "expected": 5.0,
            "unit": "s",
            "clause": "§6.4.1",
        },
        {
            "step_id": "IST-011",
            "seq": 11,
            "desc": "Exhaust backpressure check" if is_gen else "Chilled water bypass valve modulation",
            "criteria": "Backpressure below 10 kPa at rated output"
            if is_gen
            else "Modulates smoothly from 0-100% open",
            "param": "backpressure" if is_gen else "valve_mod",
            "expected": 10 if is_gen else "100%",
            "unit": "kPa" if is_gen else "",
            "clause": "§6.2.5" if is_gen else "§6.3.5",
        },
        {
            "step_id": "IST-012",
            "seq": 12,
            "desc": "Emergency Power Off integration",
            "criteria": "EPO button cuts main contacts within 100ms",
            "param": "epo_time",
            "expected": 100,
            "unit": "ms",
            "clause": "§9.5.1",
        },
        {
            "step_id": "IST-013",
            "seq": 13,
            "desc": "Battery charger float voltage",
            "criteria": "Constant float at 27.2 VDC",
            "param": "charger_voltage",
            "expected": 27.2,
            "unit": "VDC",
            "clause": "§9.2.3",
        },
        {
            "step_id": "IST-014",
            "seq": 14,
            "desc": "Pre-heating jacket coolant temperature" if is_gen else "Water treatment chemical concentration",
            "criteria": "Maintains continuous temperature above 40°C"
            if is_gen
            else "Conductivity levels below 1500 uS/cm",
            "param": "coolant_temp" if is_gen else "water_conductivity",
            "expected": 40 if is_gen else 1500,
            "unit": "°C" if is_gen else "uS/cm",
            "clause": "§6.2.7" if is_gen else "§6.3.8",
        },
        {
            "step_id": "IST-015",
            "seq": 15,
            "desc": "Phase rotation & voltage balance check",
            "criteria": "Under 1% voltage unbalance between phases",
            "param": "voltage_unbalance",
            "expected": 1,
            "unit": "%",
            "clause": "§9.1.5",
        },
        {
            "step_id": "IST-016",
            "seq": 16,
            "desc": "Fuel filtration system efficiency" if is_gen else "Leak detection sensors functionality",
            "criteria": "Particulate compliance below ISO 4406 18/16/13"
            if is_gen
            else "Triggers alarm upon water presence in under 5s",
            "param": "fuel_purity" if is_gen else "leak_alarm_time",
            "expected": "ISO 18/16/13" if is_gen else 5,
            "unit": "" if is_gen else "s",
            "clause": "§6.2.9" if is_gen else "§6.3.9",
        },
        {
            "step_id": "IST-017",
            "seq": 17,
            "desc": "Fire suppression interlocks verification",
            "criteria": "System shuts down upon simulated release trigger",
            "param": "fire_interlock",
            "expected": "Compliant",
            "unit": "",
            "clause": "§11.1.2",
        },
        {
            "step_id": "IST-018",
            "seq": 18,
            "desc": "Local indicator alarms visual audit",
            "criteria": "All alarm LEDs illuminate during lamp test",
            "param": "alarm_lamp_test",
            "expected": "Passed",
            "unit": "",
            "clause": "§10.1.1",
        },
        {
            "step_id": "IST-019",
            "seq": 19,
            "desc": "Cable connection bolt torques",
            "criteria": "Meets torque requirements per manufacturer spec",
            "param": "bolt_torque",
            "expected": "Compliant",
            "unit": "",
            "clause": "§9.4.1",
        },
        {
            "step_id": "IST-020",
            "seq": 20,
            "desc": "Jacket heater safety cutouts check" if is_gen else "Condenser fan speed controller sweep",
            "criteria": "Trips at 80°C threshold" if is_gen else "VFD sweep from 10Hz to 60Hz without resonance",
            "param": "heater_trip_temp" if is_gen else "vfd_sweep",
            "expected": 80 if is_gen else "Passed",
            "unit": "°C" if is_gen else "",
            "clause": "§6.2.8" if is_gen else "§6.3.10",
        },
        {
            "step_id": "IST-021",
            "seq": 21,
            "desc": "Maintenance bypass keylock interlocks",
            "criteria": "Trapped key operation prevents incorrect switching",
            "param": "keylock_interlock",
            "expected": "Secured",
            "unit": "",
            "clause": "§9.5.3",
        },
        {
            "step_id": "IST-022",
            "seq": 22,
            "desc": "Lube oil pressure levels check" if is_gen else "Expansion tank level and pressurization",
            "criteria": "Exceeds 350 kPa at rated operating speed"
            if is_gen
            else "Maintains static pressure at 150 kPa",
            "param": "oil_pressure" if is_gen else "expansion_pressure",
            "expected": 350 if is_gen else 150,
            "unit": "kPa",
            "clause": "§6.2.4" if is_gen else "§6.3.3",
        },
        {
            "step_id": "IST-023",
            "seq": 23,
            "desc": "Cooling airflow static pressure",
            "criteria": "Airflow velocity meets design specification",
            "param": "airflow_velocity",
            "expected": "Compliant",
            "unit": "",
            "clause": "§6.4.3",
        },
...
async def close_checklist_session(
    ...
    redis_client.set_json(
        f"inspector:as_built:{_tenant_cache_part(tenant_id)}:{equipment_tag.upper()}", record, ttl=86400
    )
    ...
    for step in steps:
        if step.get("status") == "fail":
            transcript = (
                step.get("notes")
                or f"{step.get('description', '')} failed criteria: {step.get('acceptance_criteria', '')}"
            )
