...
class PrimaveraClient:
    ...
    def exchange_code(self, base_url: str, code: str) -> dict:
        ...
        payload = {"grant_type": "authorization_code", "code": code, "redirect_uri": PRIMAVERA_CALLBACK_URL}
    ...
    def test_connection(self, tenant_id: str = None):
        ...
        demo_config = {
            "base_url": (config.get("base_url") if config else None) or "https://primavera.demo.strand.build",
            "username": "admin@strand-demo.com",
        }
